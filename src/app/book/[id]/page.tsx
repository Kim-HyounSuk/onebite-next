	...
	return (
		<div className='flex flex-col gap-2.5'>
			...
			>
				...
				<img src={coverImgUrl} alt='Cover' className='z-10 max-h-[350px] h-full' />
			</div>
			...
			<div className='bg-gray-100 p-4 leading-relaxed whitespace-pre-line rounded-md'>{description}</div>
		</div>
	);
}
